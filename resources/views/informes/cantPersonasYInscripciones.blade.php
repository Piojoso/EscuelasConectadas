            ...
            <div class="col-md-10">
                <div class="card">
                    <div class="card-header">
                        {{ __('Cantidad de Personas y Promedio de Inscripciones por Persona')}}
                    </div>
                    <div class="card-body">
                        <div class="row justify-content-center">
                            <div class="col-md-12">
                                <form action="{{ route('cantPersonasYInscripciones.show') }}" method="POST">
                                    @csrf
                                ...
                                <div class="table-responsibe">
                                    <table class="table">
                                        <thead>
                                            <tr>
                                                <th></th>
                                                <th>{{ __('Cant Teachers') }}</th>
                                                <th>{{ __('AVG Inscripciones') }}</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <tr>
                                                <th>{{ __('Locality') }}</th>
                                                <td>{{ $localidad[0]->cantPersonas }}</td>
                                                <td>{{ $localidad[1]->avgInscripciones }}</td>
                                            </tr>
                                            <tr>
                                                <th>{{ __('Department') }}</th>
                                                <td>{{ $departamento[0]->cantPersonas }}</td>
                                                <td>{{ $departamento[1]->avgInscripciones }}</td>
                                            </tr>
                                    </table>
                                </div>
