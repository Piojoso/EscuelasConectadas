        ...
        <div class="col-md-10">
            <div class="card">
                <div class="card-header">
                    {{ __('Cantidad de Escuelas sin Responsable')}}
                </div>
                <div class="card-body">
                    <div class="row justify-content-center">
                        <div class="col-md-12">
                            <form action="{{ route('cantEscuelasSinResponsable.show') }}" method="POST">
                                @csrf
                            ...
                            <div class="table-responsibe">
                                <table class="table">
                                    <thead>
                                        <tr>
                                            <th></th>
                                            <th>{{ __('Cant Schools') }}</th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <tr>
                                            <th>{{ __('Locality') }}</th>
                                            <td>{{ $localidad[0]->cantSchools }}</td>
                                        </tr>
                                        <tr>
                                            <th>{{ __('Department') }}</th>
                                            <td>{{ $departamento[0]->cantSchools }}</td>
                                        </tr>
                                    </table>
                                </div>
