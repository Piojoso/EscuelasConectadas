            ...
            <div class="col-md-10">
                <div class="card">
                    <div class="card-header">
                        {{ __('Cantidad de Personas y Promedio de Cargos por Persona')}}
                    </div>
                    <div class="card-body">
                        <div class="row justify-content-center">
                            <div class="col-md-12">
                                <form action="{{ route('cantPersonasYCargos.show') }}" method="POST">
                                    @csrf
                                    ...
                                    <table class="table">
                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>{{ $localidad[1]->avgCargo }}</td>
                                            </tr>
                                            <tr>
                                                <th>{{ __('Department') }}</th>
                                                <td>{{ $departamento[0]->cantPersonas }}</td>
                                                <td>{{ $departamento[1]->avgCargo }}</td>
                                            </tr>
                                    </table>
                                </div>
